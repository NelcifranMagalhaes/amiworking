        ...
        <form onSubmit={this.handleSubmit.bind(this)} className='max-w-2xl bg-white py-10 px-5 m-auto w-full mt-10'>
          ...
          <div className="grid grid-cols-2 gap-4 max-w-xl m-auto">
            ...
            <div className="col-span-2 lg:col-span-1">
              <input type="date" value={this.state.dateWork} onChange={this.handleInputChange} name="dateWork" id="date-work" className="border-solid border-gray-400 border-2 p-3 md:text-xl w-full" placeholder="Qual a Data"/>
            </div>
            ...
            <div className="col-span-2">
              ...
              <div className="flex items-center">
                <input id="default-radio-2" type="radio" value="false" onChange={this.handleInputChange} name="workToday" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                <label htmlFor="default-radio-2" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Não</label>
              </div>
            </div>
